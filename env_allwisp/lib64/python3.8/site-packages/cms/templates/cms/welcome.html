    ...
    <div class="cms-reset cms-welcome">
        <header class="cms-welcome-header">
            ...
            <a href="/" class="cms-welcome-logo">
                <span class="cms-hidden">{% trans "CMS" %}</span>
            </a>
        </header>
        {{ request.version }}
        ...
        <section class="cms-welcome-section">
            ...
            <p>
                {% blocktrans %}
                    Welcome to CMS version <strong>{{ cms_version }}</strong>.
                {% endblocktrans %}
            </p>
            <p>
        ...
        <footer class="cms-welcome-footer">
            ...
            <p class="cms-welcome-links">
                <a href="//django-cms.org/" target="_blank">{% trans "CMS" %}</a>
            ...
            {% blocktrans %}
                <p class="cms-welcome-notes">If you don't see the CMS logo at the top, make sure
