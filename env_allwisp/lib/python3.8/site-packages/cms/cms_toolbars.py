...
class BasicToolbar(CMSToolbar):
	...
	def add_admin_menu(self):
		if not self._admin_menu:
			...
			# Disable toolbar
			#begin edit n.4 / 11-11-2021 / rimozione pulsate disable toolbar
	...
	def add_language_menu(self):
		...
		#begin edit n.5 / 17-11-2021 / codice originale (LANGUAGE_MENU_IDENTIFIER, _('Language'), position=-1)
...
#begin edit n.3 / 10-11-2021 / aggiunta pulsante con link per app ToDo
@apphook_pool.register  # register the application
class ToDoApphook(CMSApp):
	app_name = "todo"
	name = "ToDo App"
...
class ToDoToolbar(CMSToolbar):
	supported_apps = ['todo']
	def populate(self):
		'''self.toolbar.get_or_create_menu(
			'todo_cms_integration-polls',  # a unique key for this menu
			'TODO',                        # the text that should appear in the menu
			)'''
...
toolbar_pool.register(ToDoToolbar)	
#end edit n.3
