...
<!-- Mobile Specific Meta
  ...
  <link rel="stylesheet" href="{% static 'plugins/frontend_theme/themefisher-font/style.css' %}">
  <!-- bootstrap.min css -->
  <link rel="stylesheet" href="{% static 'plugins/bootstrap/css/bootstrap.min.css' %}">
  <!-- Lightbox.min css -->
  <link rel="stylesheet" href="{% static 'plugins/frontend_theme/lightbox2/dist/css/lightbox.min.css' %}">
  <!-- animation css -->
  <link rel="stylesheet" href="{% static 'plugins/frontend_theme/animate/animate.css' %}">
  <!-- Slick Carousel -->
  <link rel="stylesheet" href="{% static 'plugins/frontend_theme/slick/slick.css' %}">
  <!-- Main Stylesheet -->
  <link rel="stylesheet" href="{% static 'plugins/frontend_theme/css/style.css' %}"> 
  ...
  <div class="container">
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
      ...
      <a class="navbar-brand logo" href="{% url 'index' %}">
        <img class="logo-default" src="{% static 'images/logofrontend.png' %}" alt="logo"/>
        <img class="logo-white" src="{% static 'images/logofrontend-white.png' %}" alt="logo"/>
      </a>
      <!-- /logo -->
      ...
      <div class="collapse navbar-collapse" id="navigation">
        <ul class="navbar-nav ml-auto text-center">
          ...
          <li class="nav-item ">
            <a class="nav-link" href="{% url 'todo:external_add_public' %}">Contact</a>
          </li>
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              ...
              <a class="dropdown-item" href="{% url 'blog' %}">Blog Page</a>
              <a class="dropdown-item" href="{% url 'single-post' %}">Blog Single Page</a>
            </div>
          </li>
        </ul>
      </div>
...
==================================== -->
	...
	<div class="slider-item th-fullpage hero-area" style="background-image: url({% static 'images/slider/slider-bg-1.jpg' %});">
		<div class="container">
			<div class="row">
				<div class="col-md-12 text-center">
					...
					<a data-duration-in=".3" data-animation-in="fadeInUp" data-delay-in=".8" class="btn btn-main" href="{% url 'service' %}">Explore Us</a>
				</div>
			</div>
		</div>
	</div>
	<div class="slider-item th-fullpage hero-area" style="background-image: url({% static 'images/slider/slider-bg-2.jpg' %});">
		<div class="container">
			<div class="row">
				<div class="col-md-12 text-center">
					...
					<a data-duration-in=".3" data-animation-in="fadeInDown" data-delay-in=".8"  class="btn btn-main" href="{% url 'service' %}">Explore Us</a>
				</div>
			</div>
		</div>
	</div>
...
<section class="about" id="about">
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6">
				<img src="{% static 'images/about-us.jpg' %}" class="img-fluid" alt="">
			</div>
			<div class="col-md-6">
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 text-center">
				...
				<a href="{% url 'contact' %}" class="btn btn-main">Contact Us</a>
			</div>
		</div> 		<!-- End row -->
	</div>   	<!-- End container -->
</section>   <!-- End section -->
		...
		<div class="row">
			<div class="col-md-12">
				<div id="clients-slider" class="clients-logo-slider">
					<img src="{% static 'images/client-logo/logo1.png' %}" alt="">
					<img src="{% static 'images/client-logo/logo-2.png' %}" alt="">
					<img src="{% static 'images/client-logo/logo-3.png' %}" alt="">
					<img src="{% static 'images/client-logo/logo-4.png' %}" alt="">
					<img src="{% static 'images/client-logo/logo-5.png' %}" alt="">
					<img src="{% static 'images/client-logo/logo1.png' %}" alt="">
					<img src="{% static 'images/client-logo/logo-2.png' %}" alt="">
					<img src="{% static 'images/client-logo/logo-3.png' %}" alt="">
					<img src="{% static 'images/client-logo/logo-4.png' %}" alt="">
				...
				<div class="row filtr-container">
					<div class="col-md-3 col-sm-6 col-xs-6 filtr-item " data-category="mix, design">
						<div class="portfolio-block">
							<img class="img-fluid" src="{% static 'images/portfolio/portfolio-1.jpg' %}" alt="">
							<div class="caption">
								<a class="search-icon" href="{% static 'images/portfolio/portfolio-1.jpg' %}" data-lightbox="image-1">
					...
					<div class="col-md-3 col-sm-6 col-xs-6 filtr-item " data-category="mix, design, ios">
						<div class="portfolio-block">
							<img class="img-fluid" src="{% static 'images/portfolio/portfolio-2.jpg' %}" alt="">
							<div class="caption">
								<a class="search-icon" href="{% static 'images/portfolio/portfolio-2.jpg' %}" data-lightbox="image-1">
									<i class="tf-ion-ios-search-strong"></i>
								</a>
								<h4><a href="">AirBnB Postcard</a></h4>
							</div>
					...
					<div class="col-md-3 col-sm-6 col-xs-6 filtr-item " data-category="mix, photography, development">
						<div class="portfolio-block">
							<img class="img-fluid" src="{% static 'images/portfolio/portfolio-3.jpg' %}" alt="">
							<div class="caption">
								<a class="search-icon" href="{% static 'images/portfolio/portfolio-3.jpg' %}" data-lightbox="image-1">
									<i class="tf-ion-ios-search-strong"></i>
								</a>
								<h4><a href="">AirBnB Postcard</a></h4>
							</div>
					...
					<div class="col-md-3 col-sm-6 col-xs-6 filtr-item " data-category="mix, photography, ios">
						<div class="portfolio-block">
							<img class="img-fluid" src="{% static 'images/portfolio/portfolio-4.jpg' %}" alt="">
							<div class="caption">
								<a class="search-icon" href="{% static 'images/portfolio/portfolio-4.jpg' %}" data-lightbox="image-1">
									<i class="tf-ion-ios-search-strong"></i>
								</a>
								<h4><a href="">AirBnB Postcard</a></h4>
							</div>
					...
					<div class="col-md-3 col-sm-6 col-xs-6 filtr-item " data-category="mix, design">
						<div class="portfolio-block">
							<img class="img-fluid" src="{% static 'images/portfolio/portfolio-5.jpg' %}" alt="">
							<div class="caption">
								<a class="search-icon" href="{% static 'images/portfolio/portfolio-5.jpg' %}" data-lightbox="image-1">
									<i class="tf-ion-ios-search-strong"></i>
								</a>
								<h4><a href="">AirBnB Postcard</a></h4>
							</div>
					...
					<div class="col-md-3 col-sm-6 col-xs-6 filtr-item " data-category="mix, design, development">
						<div class="portfolio-block">
							<img class="img-fluid" src="{% static 'images/portfolio/portfolio-6.jpg' %}" alt="">
							<div class="caption">
								<a class="search-icon" href="{% static 'images/portfolio/portfolio-6.jpg' %}" data-lightbox="image-1">
									<i class="tf-ion-ios-search-strong"></i>
								</a>
								<h4><a href="">AirBnB Postcard</a></h4>
							</div>
					...
					<div class="col-md-3 col-sm-6 col-xs-6 filtr-item " data-category="mix, photography">
						<div class="portfolio-block">
							<img class="img-fluid" src="{% static 'images/portfolio/portfolio-7.jpg' %}" alt="">
							<div class="caption">
								<a class="search-icon" href="{% static 'images/portfolio/portfolio-7.jpg' %}" data-lightbox="image-1">
									<i class="tf-ion-ios-search-strong"></i>
								</a>
								<h4><a href="">AirBnB Postcard</a></h4>
							</div>
		...
		<div class="row">
			...
			<div class="col-md-4 col-sm-6 ">
				<div class="team-member text-center">
					<div class="member-photo">
						<!-- member photo -->
						<img class="img-fluid" src="{% static 'images/team/member-1.jpg' %}" alt="Meghna">
						<!-- /member photo -->
			...
			<div class="col-md-4 col-sm-6 ">
				<div class="team-member text-center">
					<div class="member-photo">
						<!-- member photo -->
						<img class="img-fluid" src="{% static 'images/team/member-2.jpg' %}" alt="Meghna">
						<!-- /member photo -->
			...
			<div class="col-md-4 col-sm-6 ">
				<div class="team-member text-center">
					<div class="member-photo">
						<!-- member photo -->
						<img class="img-fluid" src="{% static 'images/team/member-3.jpg' %}" alt="Meghna">
						<!-- /member photo -->
					...
					<div class="testimonial-slider">
						...
						<div class="item text-center">
							...
							<div class="client-thumb">
								<img src="{% static 'images/client-logo/clients-1.jpg' %}" class="img-fluid" alt="">
							</div>
						...
						<div class="item text-center">
							...
							<!-- client photo -->
							<div class="client-thumb">
								<img src="{% static 'images/client-logo/clients-2.jpg' %}" class="img-fluid" alt="">
							</div>
							<div class="client-meta">
								<h3>Emma Harrison</h3>
								<span>CEO , Company Name</span>
						...
						<div class="item text-center">
							...
							<!-- client photo -->
							<div class="client-thumb">
								<img src="{% static 'images/client-logo/clients-3.jpg' %}" class="img-fluid" alt="">
							</div>
							<div class="client-meta">
	...
	<div class="container">
		<div class="row">
			...
			<article class="col-md-4 col-sm-6 col-xs-12 clearfix ">
				<div class="post-item">
					<div class="media-wrapper">
						<img src="{% static 'images/blog/post-1.jpg' %}" alt="amazing caves coverimage" class="img-fluid">
					</div>

					<div class="content">
						<h3><a href="{% url 'single-post' %}">Reasons to Smile</a></h3>
						<p>Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf
							moon officia aute, non skateboard dolor brunch.</p>
						<a class="btn btn-main" href="{% url 'single-post' %}">Read more</a>
					</div>
				</div>
			</article>
			<!-- /single blog post -->
			...
			<article class="col-md-4 col-sm-6 col-xs-12 ">
				<div class="post-item">
					<div class="media-wrapper">
						<img src="{% static 'images/blog/post-2.jpg' %}" alt="amazing caves coverimage" class="img-fluid">
					</div>

					<div class="content">
						<h3><a href="{% url 'single-post' %}">A Few Moments</a></h3>
						<p>Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf
							moon officia aute, non skateboard dolor brunch.</p>
						<a class="btn btn-main" href="{% url 'single-post' %}">Read more</a>
					</div>
			...
			<article class="col-md-4 col-sm-6 col-xs-12 ">
				<div class="post-item">
					<div class="media-wrapper">
						<img src="{% static 'images/blog/post-3.jpg' %}" alt="amazing caves coverimage" class="img-fluid">
					</div>

					<div class="content">
						<h3><a href="{% url 'single-post' %}">Hints for Life</a></h3>
						<p>Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf
							moon officia aute, non skateboard dolor brunch.</p>
						<a class="btn btn-main" href="{% url 'single-post' %}">Read more</a>
					</div>
...
<!--====  End of Mapbox  ====-->
  ...
  <div class="footer-bottom">
    ...
    <h6>Design and Developed by <a href="">Arpanet Italia Srl</a></h6>
  </div>
</footer> <!-- end footer -->
    ...
    <!-- Form Validation -->
    <script src="{% static 'plugins/frontend_theme/form-validation/jquery.form.js' %}"></script> 
    <script src="{% static 'plugins/frontend_theme/form-validation/jquery.validate.min.js' %}"></script>
    <!-- Parallax -->
    <script src="{% static 'plugins/frontend_theme/parallax/jquery.parallax-1.1.3.js' %}"></script>
    <!-- lightbox -->
    <script src="{% static 'plugins/frontend_theme/lightbox2/dist/js/lightbox.min.js' %}"></script>
    <!-- Owl Carousel -->
    <script src="{% static 'plugins/frontend_theme/slick/slick.min.js' %}"></script>
    <!-- filter -->
    <script src="{% static 'plugins/frontend_theme/filterizr/jquery.filterizr.min.js' %}"></script>
    <!-- Smooth Scroll js -->
    <script src="{% static 'plugins/frontend_theme/smooth-scroll/smooth-scroll.min.js' %}"></script>
    
    <!-- Custom js -->
    <script src="{% static 'plugins/frontend_theme/js/script.js' %}"></script>
	...
	<!-- Mapbox -->
	<script>
    mapboxgl.accessToken = 'pk.eyJ1IjoiYXJwYW5ldGl0YWxpYSIsImEiOiJja3ZiZGxmbTEya3hmMnBsdWVhZWFuNmw1In0.vMR0-fmLRsFHd2OZyLrrrw';
    const map = new mapboxgl.Map({
     container: 'map',
     style: 'mapbox://styles/mapbox/streets-v11',
	 center: [9.1009068, 45.4783899],
     zoom: 15
	 
    });
	
	//const popup = new mapboxgl.Popup()
	//.setLngLat([9.1009068, 45.4783899])
	//.setHTML('<p><a href="https://bit.ly/3mPB8fU" target="_blank">via Caldera 21, Milano</a></p>')
	//.addTo(map);
	...
	'type': 'Point',
	'coordinates': [
	9.1009068, 45.4783899
	]
	},
	'properties': {
	'title': 'via Caldera 21, Milano'
	}
	}
