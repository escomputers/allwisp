...
class Customer (models.Model):
	...
	importo_attivazione = models.FloatField(blank=True, default=0.0)
	...
	numero_voip =numero_voip =PhoneNumberField( default='+39',blank=True)
	...
	data_installazione=models.DateField(default=datetime.date.today)
