...
class clientiForm(forms.ModelForm):
	class Meta:
		...
		widgets={
			...
			'data_installazione' : DateInput(attrs={"class":"form-control","id":"data_installazione"}),
			'data_inizio_contratto' : DateInput(attrs={"class":"form-control","id":"data inizio contartto"}),
			'data_fine_contratto' : DateInput(attrs={"class":"form-control","id":"data_fine_contratto"}),
