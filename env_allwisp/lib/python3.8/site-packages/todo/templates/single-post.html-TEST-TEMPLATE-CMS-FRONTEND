      ...
      <div class="col-lg-8">
        <article class="post">
          <div class="post-image">
            <img class="img-fluid w-100" src="{% static 'images/blog/post-1.jpg' %}" alt="post-image">
          </div>
          <!-- Post Content -->
            ...
            <ul class="comment-list">
              ...
              <li class="comment-list-item">
                <div class="comment-list-item-image">
                  <img src="{% static 'images/blog/comment-1.jpg' %}" alt="comment-img">
                </div>
              ...
              <li class="comment-list-item">
                <div class="comment-list-item-image">
                  <img src="{% static 'images/blog/comment-2.jpg' %}" alt="comment-img">
                </div>
                <div class="comment-list-item-content">
                  <h5>Falk Burger</h5>
                  <h6>Aug 20, 2018</h6>
          ...
          <div class="widget-post widget">
            ...
            <ul class="widget-post-list">
              <li class="widget-post-list-item">
                <div class="widget-post-image">
                  <a href="{% url 'single-post' %}">
                    <img src="{% static 'images/blog/post-1.jpg' %}" alt="post-img">
                  </a>
                </div>
              ...
              <li class="widget-post-list-item">
                <div class="widget-post-image">
                  <a href="{% url 'single-post' %}">
                    <img src="{% static 'images/blog/post-2.jpg' %}" alt="post-img">
                  </a>
                </div>
                <div class="widget-post-content">
                  <a href="{% url 'single-post' %}">
              ...
              <li class="widget-post-list-item">
                <div class="widget-post-image">
                  <a href="{% url 'single-post' %}">
                    <img src="{% static 'images/blog/post-3.jpg' %}" alt="post-img">
                  </a>
                </div>
                <div class="widget-post-content">
                  <a href="{% url 'single-post' %}">
