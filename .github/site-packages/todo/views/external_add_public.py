...
def external_add_public(request) -> HttpResponse:
	...
	if request.POST:
		...
		if form.is_valid():
			...
			#if defaults("TODO_DEFAULT_ASSIGNEE_EXT"):
			task.assigned_to = get_user_model().objects.get(username='sitoweb')
			task.save()
			...
			#rimozione messaggio di successo, non serve
			#messages.success(
