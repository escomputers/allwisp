...
datafinalecon9=dataaddattamento.date()
...
#print(numOfDays(datainiziosenzaora, datafinalecon10))


differenzagiorni=numOfDays(datainiziosenzaora, datafinalecon9)
print(differenzagiorni)
b=15. #prendere il valore dell'offerta)

tariffa_addattamento=b/30
a=tariffa_addattamento*differenzagiorni

print('prezzo finale', a)
