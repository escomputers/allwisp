...
class Customer (models.Model):
	...
	offerta_internet = models.ForeignKey(offertainternet, on_delete=models.CASCADE,blank=True, null=True) 
	cadenza_pagamento = models.ForeignKey(cadenzapagamento, on_delete=models.CASCADE, blank=True, null=True) 
