          ...
          <div class="col-sm-3">
              ...
              <div class="row">
                  <div class="col-sm-2">
                    <!-- text input -->
                    <div class="form-group">
                      <label for="customer_id">Id cliente. {%if ultimoid.customer_id%}<font color="#ff4d01">Ultimo id inserito: <B><I>{{ultimoid.customer_id}}</font></I></B></label>{%else%}<font color="#ff4d01">Ultimo id inserito: <B><I>{{ultimoid}}</font></I></B></label>{%endif%}
                      {{ clienti.customer_id }}
                      <p id='customer_id_label' hidden><font color='red'><small>Questo id è già registrato</small></font></p>
                    </div>
                  </div>
                  <div class="col-sm-2">
                    <!-- text input -->
...
<div class="modal fade" id="modalesuccesso" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Cliente salvato correttamente</h5>
            </div>
 ...
 <div class="testo">
      <div style="border-radius:200px; height:200px; width:200px; background: #F8FAF5; margin:0 auto;">
        ...
        <h2 class="h1">Il cliente è stato salvato con successo</h2> 
        <br>
        <p class="p"><small><strong><font color="#0275d8">Il cliente è stato salvato correttamente. Per altre operazioni naviga con i pulsanti di sotto oppure usa il menu laterale.</font></strong></small></p> 

</div>
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-success" data-dismiss="modal">Agg.altri</button>
              <button type="button" class="btn btn-primary"><i class="fa fa-home"></i></button>
              <button type="button" class="btn btn-primary" href="{% url 'customer_list' %}">lista clienti</button>
            </div>
          </div>
        </div>
      </div>
...
{% endif %}
  ...
  {% if successful_submit_interessati %}
    <script type="text/javascript">
        $(document).ready(function(){
            $("#modalesuccessointeressati").modal('show');
        });
    </script>
{% endif %}

<div class="modal fade" id="modalesuccessointeressati" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Cliente salvato correttamente</h5>
 ...
 <div class="testo">
      <div style="border-radius:200px; height:200px; width:200px; background: #F8FAF5; margin:0 auto;">
        ...
        <h2 class="h1">Il cliente interessato è stato salvato con successo</h2> 
        <br>
        <p class="p"><small><strong><font color="#0275d8">Il cliente è stato salvato correttamente. Per altre operazioni naviga con i pulsanti di sotto oppure usa il menu laterale.</font></strong></small></p> 
</div>
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response.is_taken == true) {
                            ...
                            $('#customer_id_label').prop('hidden',false);
                        }
                        else {
                            $('#customer_id').removeClass('is-invalid').addClass('is-valid');
                             $('#customer_id_label').prop('hidden',true);
