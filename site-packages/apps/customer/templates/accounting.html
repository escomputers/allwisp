...
<div class="panel panel-primary">
	...
	<table class="table table-hover">
		...
		<tr>
			...
			<td class="text-right"><a href="{% url 'invoice' invoice.id %}" class="btn btn-xs btn-primary">View Invoice</a></td>
		</tr>
		{% endfor %}
	</table>
...
<div class="panel panel-primary">
	...
	<table class="table table-hover">
		...
		<tr>
			...
			<td>{{ expense.qty }}</td>
			<td>${{ expense.total }}</td>
			<td class="text-right">{% if expense.invoice_id %}<a href="{% url 'invoice' expense.invoice_id %}" class="btn btn-xs btn-primary">View Invoice</a>{% endif %}</td>
		</tr>
		{% endfor %}
	</table>
...
<form action="{% url 'accounting' %}" method="POST" class="form-horizontal">
{% csrf_token %}
	<div class="panel panel-primary">
