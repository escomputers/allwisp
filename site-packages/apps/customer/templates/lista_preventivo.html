      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Lista_preventivi</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
...
<div class="row">
	<div class="col-sm-6">
          <h4>Crea nuovo documento fiscale<a type="button"  class="btn btn-sm " href="{% url 'new_invoice' %}"><i><img alt="aggiungi-clienti" src="/static/images/piu.svg" width="40px" title="Crea nuovo documento"></i></a></h4>
      </div>
</div>
...
<div class="col-sm-12">
  ...
  <h1 class="card-title">Lista dei preventivi</h1>
</div>
<div class="card-body">  
        
             
	<table  id="tabellaclienti"  class="table-responsive compact cell-border  row-border stripe " style="width:200%">
		...
		{% for liste in lista %}
		<tr>
			<td class="text-center id">{{ liste.preventivo_id }}</td>
			...
			<td class="text-center">{{ liste.scadenza_preventivo }}</td>
