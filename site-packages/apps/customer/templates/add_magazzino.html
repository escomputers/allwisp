...
<div class="content-wrapper">
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Aggiungi prodotto magazzino </h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Aggiungi_prodotto_magazzino</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
  ...
  <section class="content">
    ...
    <div class="container-fluid">
       ...
       <form method="POST"  action="{% url 'aggiungi_offerta_voip'%}" name="aggiungi_offerta_voip">
      {% csrf_token %}
          <div class="card card-warning">
            <div class="card-header">
              <h3 class="card-title">Aggiungi offerta Voip</h3>
            </div><!-- /.card-header -->
         <div class="card-body">
                <div class="row">
                  <div class="col-sm-2">
...
<script type="text/javascript">
  $('#aggiungi_offerta_voip').submit(function(event){
        event.preventDefault();
        var $prodotto = $(this);
        $.ajax({
        type: 'post',
        url: "{% url 'aggiungi_offerta_voip'%}",
