 ...
 <div class="content-wrapper">
	...
	<div class="col-sm-6">
	  <h2>Lista Clienti</h2>
		...
		<h3 class="card-title"><font color="#fffff">Ultimo ID cliente inserito:&nbsp;{{ultimoid.customer_id}}&nbsp;<i class="fas fa-exclamation"></i></font></h3>
		</div>
		</div>
		</div>
...
<div class="panel panel-primary">
	...
	<div class="row mb-2">
		...
		<div class="card-header">
		<h3 class="card-title">Suggerimento&nbsp;<font color="#fffff"><i class="fas fa-comment-dots"></i></font></h3>
		</div>
		<div class="card-body">
...
<div class="content-wrapper">
  <section class="content-header">
	...
	<div class="alert alert-warning">No customers!</div>
      <div class="row mb-2">
        <div class="col-sm-6">
          <h4>Aggiungi nuovo cliente<a type="button"  class="btn btn-sm" href="{% url 'add_client' %}"><i><img alt="aggiungi-clienti" src="{% static 'images/aggiungi-clienti.svg' %}" width="40px" title="Nuovo cliente"></i></a></h4>
      </div>
      </div>
    </div><!-- /.container-fluid -->
