...
from forms import clientiForm, offertainternetForm, cadenzapagamentoform, metodopagamento, offertavoipForm
...
def aggiungi_cliente(request):
	clienti = clientiForm(request.POST or None)
	try:
		ultimo_idcliente = Customer.objects.latest('customer_id')
	except Customer.DoesNotExist:
		ultimo_idcliente = "nessun id"
	if request.method == "POST":	
		if clienti.is_valid():
			clienti.save()
			return redirect('lista_clienti')
		#else:
		#	print(clienti.errors)
	context = {"clienti":clienti, 'ultimoid':ultimo_idcliente}
