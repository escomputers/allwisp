...
urlpatterns =[
	# # # DEFAULT
	path('<int:document_id>/item/add', views.add_item, name='add_item'),
	path('<int:document_id>/item/<int:documentitem_id>/delete', views.delete_item, name='delete_item'),
	...
	path('offerta/add-extra', views.aggiungi_extra, name='aggiungi_extra'),
