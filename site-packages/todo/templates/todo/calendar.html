  ...
  <h2>Agenda</h2>
	...
	<div class="togglediv_allDay">
        ...
        <span class="input-group-text"><i class="far fa-calendar"></i></span>
		  ...
		  <input type="text" name="start" class="form-control pull-right" placeholder="Data inizio evento" id="start" onfocus="(this.type='date')" >
		</div>
        ...
        <span class="input-group-text"><i class="far fa-calendar"></i></span>
		   ...
		   <input type="text" name="end" class="form-control pull-right" placeholder="Data fine evento" id="end" onfocus="(this.type='date')" >
		</div>
	</div>
	...
	<div class="togglediv_cadenza">
		...
		<!-- Pulsantiera -->
			...
			<td style="text-align:center;">
			<input type="checkbox" id="recur_everyday" checked="true" data-toggle="toggle" data-on="On" data-off="Off" data-onstyle="success" data-offstyle="secondary" data-size="normal">
			</td>
			</tr>
			...
			<tr>
			<td><label id="label_form_type">Evento passato</label></td>
			<td style="text-align:center;">
			<input type="checkbox" name="note" id="note" data-toggle="toggle" data-on="On" data-off="Off" data-onstyle="success" data-offstyle="secondary" data-size="normal">
			</td>
			</tr>
			</tbody>
			</table>
...
<script>
	...
	//Inizializza variabili per successiva funzione dopo
	var sel_h1 = document.getElementById('sel_h1');
	var sel_d1 = document.getElementById('sel_d1');
	var sel_d2 = document.getElementById('sel_d2');
	
	//Nascondi selezione oraria in quanto allDay e' ON di default
	sel_h1.style.display = 'none';
	
	//Hide-Show specific div by default
	...
	sel_h1.style.display = 'none';
	//Mostra quelle giornaliere
	sel_d1.style.display = '';
	sel_d2.style.display = '';
	...
	//Nascondi le selezioni giornaliere del campo Avvisami
	sel_d1.style.display = 'none';
	sel_d2.style.display = 'none';
	//Mostra quelle orarie
	sel_h1.style.display = '';
