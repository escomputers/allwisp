  ...
  <h2>Agenda</h2>
	...
	<div class="input-group mb-3">
	 <select name="color" class="form-control select2bs4_color" style="width: 100%;">
		...
		<input type="checkbox" name="notify" id="notify" data-toggle="toggle" data-on="On" data-off="Off" data-onstyle="success" data-offstyle="secondary" data-size="small">
		</div>
		</div>
		</div>
...
<script>
	...
	//var id_data = {date_id: data_con_orario};
    $.ajax({
