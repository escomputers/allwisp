...
class Evento(models.Model):
	...
	def __str__(self):
		return str(self.id)
		"""
		return 's_id,%s,e_id,s_title,%s,e_title,s_start,%s,e_start,s_notify,%s,e_notify,s_notify_time,%s,e_notify_time,s_isRecur,%s,e_isRecur,s_startRecur,%s,e_startRecur,s_endRecur,%s,e_endRecur,s_startTime,%s,e_startTime,s_endTime,%s,e_endTime,s_daysOfWeek,%s,e_daysOfWeek' % (
		(str(self.id)), 
		(str(self.title)), 
		(str(self.start)), 
		(str(self.notify)),
