...
class Evento(models.Model):
	...
	daysOfWeek = models.CharField(max_length=3, blank=True, null=True, choices=DAYS_OF_WEEK)
	color = models.CharField(max_length=10, blank=True, null=True, choices=EVENT_COLORS)
	allDay = models.BooleanField(default=False)
	recur_everyday = models.BooleanField(default=False)
	isRecur = models.BooleanField(default=False)
	notify_time = models.CharField(max_length=15, blank=True, null=True, choices=NOTIFY_TIME)

	def __str__(self):
		return str(self.id)
		
		"""
		return 's_id,%s,e_id,s_title,%s,e_title,s_start,%s,e_start,s_notify_time,%s,e_notify_time,s_isRecur,%s,e_isRecur,s_startRecur,%s,e_startRecur,s_endRecur,%s,e_endRecur,s_startTime,%s,e_startTime,s_endTime,%s,e_endTime,s_daysOfWeek,%s,e_daysOfWeek' % (
		(str(self.id)), 
		(str(self.title)), 
		(str(self.start)), 
...
class Recur(models.Model):
    ...
    #tipo documento da prendere su apps
    
    #scelta cliente da prendere su apps
