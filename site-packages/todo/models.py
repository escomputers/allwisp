...
class Evento(models.Model):
	...
	#frequency = models.IntegerField(blank=True, null=True, choices=RECURRENCE_CHOICES)
	...
	def __str__(self):
		...
		return '%s,start,%s,end,startdate,%s,enddate,%s' % ((str(self.id)), (str(self.title)), (str(self.start)), (str(self.notify)))
