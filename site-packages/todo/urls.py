...
urlpatterns = [
	#path('frontend/', include('todoapp.urls', namespace="frontend")),
	...
	path("ticket/add/public/", views.external_add_public, name="external_add_public"),
	...
	path("calendario/events_list/", views.events_list, name="events_list"),
	path("calendario/delete_event/", views.delete_event, name="delete_event"),
	path("recur/", views.recur, name="recur"),
    path("recur/recur_form/", views.recur_form, name="recur_form"),
]
