...
;(function($) {
    $.fn.formset = function(opts)
    {
        var options = $.extend({}, $.fn.formset.defaults, opts),
            ...
            */
            ...
            insertDeleteLink = function(row) {
                ...
                var delButtonHTML = '<a class="' + options.deleteCssClass + '" href="javascript:void(0)">' + ' <i><img alt="modifica" src="/static/images/cestino.svg" width="32px"></i></a>';
        ...
        if ($$.length) {
            ...
            var addButtonHTML = '<a class="' + options.addCssClass + '" href="javascript:void(0)">' + ' <i><img alt="modifica" src="/static/images/aggiungi.svg" width="32px"></i>  <h7>Aggiungi riga</h7></a>';
