...
def validate_dependencies():
    ...
    if not app_is_installed('treebeard'):
        raise ImproperlyConfigured('CMS requires django-treebeard. Please install it and add "treebeard" to INSTALLED_APPS.')
...
def validate_settings():
    ...
    try:
        ...
        raise ImproperlyConfigured("CMS requires django.template.context_processors.request in "
