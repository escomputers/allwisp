...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
             <h1>Appunti <a id="a_d" class="btn btn-success"  data-toggle="modal" data-target="#add_note"><i class="fas fa-plus" data-toggle="tooltip" title="Add a new note"></i></a></h1>
</div>
</div>
  
   {% if messages %}
        <div class="alert" role="alert">{% include 'messages.html' %}</div>
   {% endif %}

    <div class="row" id="notes-homepage" style="margin-bottom: 10%;">
